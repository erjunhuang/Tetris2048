...
[RequireComponent(typeof(GoogleMobileAdsManger))]
...
public class Managers : MonoBehaviour
{
	...
	private static GoogleMobileAdsManger _adsManager;
	public static GoogleMobileAdsManger Ads
	{
    ...
    void Awake ()
	{
		...
		_adsManager = GetComponent<GoogleMobileAdsManger>();
